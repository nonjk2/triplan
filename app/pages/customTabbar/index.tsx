...
// const Plantabs = ({route}: any, props: any): any => {
...
//   );
// };
const OptionmyDrawer = ({route}: any) => {
  const {planday, startDate, endDate, name, source} = route.params;
...
const Taparr = [
  ...
  },
  {
    ...
    component: CheckTap,
    label: '체크리스트',
    activeIcon: 'checkbox-outline',
    inactiveIcon: 'checkbox',
    headershown: true,
    headerShadowVisible: false,
  },
  {
    route: '프로필',
    component: AddplanSetting,
    label: '프로필',
    ...
    <TouchableOpacity
      ...
      <Animatable.View
        ...
        {/* <Animatable.View
                ...
                >   */}
        <IonIcon
          name={focused ? item.inactiveIcon : item.activeIcon}
          size={28}
        ...
        <Text
          style={{
            fontSize: 8,
            color: focused ? '#5585E8' : '#000',
            marginTop: focused ? 1.5 : 4,
          }}>
          {item.label}
        </Text>
        {/* </Animatable.View> */}
...
export default function Tapmynavigation({route, navigation}: any) {
