...
function Textsetting(props: any) {
  return (
    <View style={styles.containertwo}>
      <View style={{marginTop: 37, paddingBottom: 20, paddingLeft: 16}}>
        <Text style={{fontSize: 18, fontWeight: '500', color: '#5585E8'}}>
          프로필 정보
        </Text>
      </View>
      {/* 여기는 닉네임입니다  */}
      <View style={{paddingHorizontal: 16}}>
        ...
        <View
          ...
          <Input
            ...
            onChangeText={(value: any) => props.setnickname(value)}
          />
      ...
      <View style={{paddingHorizontal: 16}}>
        ...
        <View
          style={{
            borderWidth: 2,
            borderColor:
              props.aboutMe !== props.user.aboutme && props.aboutMe.length !== 0
                ? '#5585E8'
                : '#C4C4C4',
            borderRadius: 4,
            height: 36,
          ...
          <Input
            ...
            placeholderTextColor="#767676"
            onChangeText={(value: any) => props.setabuoutMe(value)}
          />
          {/* <Text style={styles.inputvalid}>{this.state.form.planname.value.length}/10</Text> */}
          <TouchableOpacity
            style={{position: 'absolute', right: 5}}
