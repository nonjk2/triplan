...
class Imagemodal extends React.Component {
        ...
        render() {
            return (
                    <View style = {{width: 343,height: 218, borderRadius :10, bottom: '10%',   shadowOffset:{ width :2, height : 4,} , shadowOpacity : 0.28 , shadowColor : '#000'}}>
                        ...
                        <View style = {{width: 343,height: 158, borderRadius : 10,backgroundColor : '#fff' , shadowOffset:{ width :2, height : 4,} , shadowOpacity : 0.10 , shadowColor : '#000'}}>

                            <View style = {{ flex : 1, backgroundColor : '#fff' ,borderTopRightRadius : 10,borderTopLeftRadius : 10, borderBottomColor : '#C4C4C4', borderBottomWidth : 1,}}>
                            ...
                            <View style = {{ flex : 1, backgroundColor : '#fff' , borderBottomColor : '#C4C4C4' ,borderBottomWidth : 1,}}>
                            ...
                            <View style = {{ flex : 1, backgroundColor : '#fff' ,borderBottomLeftRadius : 10 , borderBottomRightRadius : 10, borderBottomColor : '#C4C4C4', borderBottomWidth : 1,}}>
                        ...
                        <TouchableOpacity
                            ...
                            style={{position: 'absolute',bottom : 1, width: 343,height: 52, borderRadius :10, backgroundColor : '#fff' , shadowOffset:{ width :2, height : 4,} , shadowOpacity : 0.28 , shadowColor : '#000' , alignItems : 'center', justifyContent :'center'}}>
