...
function ScheduleSetting(props: any) {
  ...
  const [price] = useState(props.route.params.price);
      ...
      headerRight: () => (
        <TouchableOpacity
          ...
          disabled={
            ...
            planname !== props.route.params.title
              ? planname.length > 2 && memo.length > 4
                ? false
                : true
              : true
          }>
          ...
          <Pressable
            ...
            <View
              ...
              <Input
                ...
                fontSize={16}
                marginLeft={10}
                onChangeText={(value: any) => setmemo(value)}
              />
              <TouchableOpacity
