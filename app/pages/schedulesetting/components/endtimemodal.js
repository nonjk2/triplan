...
class Endtimemodal extends Component {
        constructor(props) {
            super(props);
            this.state = {
        ...
        render() {
            ...
            return (
                <View style = {{width: 343,height: 420, borderRadius :10, shadowOffset:{ width :2, height : 4,} , shadowOpacity : 0.10 , shadowColor : '#000'}}>
                    <View style = {{width: 343,height: 360, borderRadius : 10,backgroundColor : '#fff' , shadowOffset:{ width :2, height : 4,} , shadowOpacity : 0.10 , shadowColor : '#000'}}>
