...
export const AppNavigation = () => {
  return (
    <AuthStack.Navigator>
      ...
      <AuthStack.Screen name="plan" component={Tapmynavigation} options={({route}) => ({title : route.params.name , headerShown : false,headerShadowVisible: true ,headerBackTitleVisible : false, headerTintColor : 'black' ,animation : 'fade'})} />
      <AuthStack.Screen name="일정 편집" component={ScheduleSetting} options = {{headerShadowVisible : true,headerBackTitleVisible : false, headerTintColor : 'black'}}/>
      <AuthStack.Screen name="여행 추가" component={AddplanScreen} options = {{headerShadowVisible : true,headerBackTitleVisible : false, headerTintColor : 'black'}}/>
      <AuthStack.Screen name="프로필" component={SettingScreen} options = {{headerShadowVisible : true,headerBackTitleVisible : false, headerTintColor : 'black'}}/>
